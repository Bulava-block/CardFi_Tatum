...
console.log(signer)
const contractAddress = "0xCA6284cBa9945B23832dc858946e2Fc0B954b41a";
...
async function depositJS(){
  ...
  let  currency = $("#currencyOF").val();
	...
	let tx = await contract.deposit(contractADR, tokenid, currency, amount, {value: amount})
	tx = await tx.wait()
